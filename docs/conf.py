# -*- coding: utf-8 -*-
#
# IPython Cypher documentation build configuration file, created by
...
htmlhelp_basename = 'IPythonCypherdoc'
...
latex_documents = [
  ('index', 'IPythonCypher.tex', u'IPython Cypher Documentation',
